...
function getGameCategory(title) {
    ...
    if (t.includes('bowl') || t.includes('soccer') || t.includes('basketball') || t.includes('tennis') || t.includes('volley') || t.includes('sport') || t.includes('pool') || t.includes('racer')) {
        return 'sports';
    }
    if (t.includes('mario') || t.includes('duck life') || t.includes('adventure') || t.includes('run') || t.includes('fnaf') || t.includes('neighbor') || t.includes('granny') || t.includes('baldi') || t.includes('surfers')) {
        return 'adventure';
    }
    if (t.includes('1v1') || t.includes('fight') || t.includes('smash') || t.includes('battle') || t.includes('box') || t.includes('wrestle') || t.includes('kill') || t.includes('shoot')) {
        return 'fighting';
    }
    if (t.includes('bloons') || t.includes('defend') || t.includes('strategy') || t.includes('war') || t.includes('territory') || t.includes('clash') || t.includes('roulette')) {
        return 'strategy';
    }
    if (t.includes('2048') || t.includes('puzzle') || t.includes('mahjong') || t.includes('wordle') || t.includes('chess') || t.includes('minesweeper') || t.includes('pipe') || t.includes('block') || t.includes('brick')) {
        return 'puzzle';
    }
